...
export default function ClinicalOutcomes() {
  const outcomes = [
    {
      num: '↓ 40%',
      title: 'Reduction in 30-day readmissions for our patients.',
    ...
    {
      num: '24h',
      title: 'Under 24 Hours from referral to enrollment and setup',
    ...
    {
      num: '> 85%',
      title: 'Medication Adherence—patients follow their prescription plans strictly with our supervision.',
      color: 'border-[#061324]',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-16 sm:mb-20 text-center mx-auto">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#061324] leading-tight tracking-tight">
            Moving the metrics that matter most. 
          </h2>
